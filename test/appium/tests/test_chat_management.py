...
class TestChatManagement(MultipleDeviceTestCase):
    ...
    def test_delete_1_1_chat(self):
        self.senders['user_1'] = transaction_users['G_USER']
        self.senders['user_2'] = transaction_users['H_USER']
        ...
        device_1_sign_in_view.recover_access(self.senders['user_1']['passphrase'], self.senders['user_1']['password'])
        device_2_sign_in_view = SignInView(device_2)
        device_2_sign_in_view.recover_access(self.senders['user_2']['passphrase'], self.senders['user_2']['password'])
        ...
        device_1_home_view.add_contact(self.senders['user_2']['public_key'])
        device_1_chat_view = device_1_home_view.get_chat_view()
        chat_with_user_1 = device_2_home_view.get_chat_with_user(self.senders['user_1']['username'])
        ...
        device_1_chat_view.send_transaction_in_1_1_chat(transaction_amount, self.senders['user_1']['password'])
        device_2_chat_view.request_transaction_in_1_1_chat(transaction_amount)
        device_2_chat_view.send_transaction_in_1_1_chat(transaction_amount, self.senders['user_2']['password'])
        ...
        device_1_chat_view.delete_chat(self.senders['user_2']['username'], self.errors)
        ...
        device_1_sign_in_view.sign_in(self.senders['user_1']['password'])
        assert not device_1_home_view.get_chat_with_user(self.senders['user_2']['username']).is_element_present(20)

        # Device 1: Start 1-1 chat with device 2
        device_1_chat_view = device_1_home_view.start_1_1_chat(self.senders['user_2']['username'])
